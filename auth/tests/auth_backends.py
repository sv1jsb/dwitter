...
from auth.models import User, Group, Permission, AnonymousUser
...
class BackendTest(TestCase):
    ...
    backend = 'auth.backends.ModelBackend'
...
class RowlevelBackendTest(TestCase):
    ...
    """
    backend = 'auth.tests.auth_backends.SimpleRowlevelBackend'
...
class AnonymousUserBackendTest(TestCase):
    ...
    backend = 'auth.tests.auth_backends.AnonymousUserBackend'
...
class InActiveUserBackendTest(TestCase):
    ...
    backend = 'auth.tests.auth_backends.InActiveUserBackend'
...
class NoInActiveUserBackendTest(TestCase):
    ...
    """
    backend = 'auth.tests.auth_backends.NoInActiveUserBackend'
