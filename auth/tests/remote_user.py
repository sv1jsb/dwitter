...
from auth.backends import RemoteUserBackend
...
class RemoteUserTest(TestCase):
    ...
    middleware = 'auth.middleware.RemoteUserMiddleware'
    backend = 'auth.backends.RemoteUserBackend'
...
class RemoteUserNoCreateTest(RemoteUserTest):
    ...
    backend =\
        'auth.tests.remote_user.RemoteUserNoCreateBackend'
...
class RemoteUserCustomTest(RemoteUserTest):
    ...
    backend =\
        'auth.tests.remote_user.CustomRemoteUserBackend'
